  ...
  return (
    <section className="relative isolate overflow-hidden rounded-[24px] border border-white bg-gradient-to-br from-white via-white to-[var(--as-surface-sunken)] px-6 py-8 shadow-as sm:px-8 lg:py-9">
      ...
      >
        ...
        <div className="absolute left-1/2 top-1/2 h-[148px] w-[148px] -translate-x-1/2 -translate-y-1/2 rotate-[-13deg] rounded-[38px] border border-white bg-gradient-to-br from-white/95 to-[var(--as-surface-sunken)]/75 shadow-[inset_0_2px_2px_white,0_24px_45px_-18px_rgba(70,90,120,.23)] backdrop-blur-xl" />
        <div className="absolute left-1/2 top-1/2 flex h-[148px] w-[148px] -translate-x-1/2 -translate-y-1/2 rotate-[8deg] items-center justify-center rounded-[38px] border border-white/90 bg-gradient-to-br from-white/75 to-[var(--as-surface-sunken)]/65 shadow-[inset_0_2px_1px_white,0_10px_30px_-10px_rgba(70,90,120,.13)] backdrop-blur-sm">
          <AxiomMark className="h-[76px] w-[76px] text-[var(--as-text-muted)]" />
        </div>
        <span className="absolute left-12 top-[96px] h-2 w-2 rounded-full border border-white bg-[var(--as-border-strong)] shadow-sm" />
        <span className="absolute bottom-[75px] right-[71px] h-1.5 w-1.5 rounded-full bg-[var(--as-border-strong)]" />
        <span className="absolute bottom-4 left-1/2 -translate-x-1/2 whitespace-nowrap text-[8px] tracking-[.28em] text-[var(--as-text-muted)]">
