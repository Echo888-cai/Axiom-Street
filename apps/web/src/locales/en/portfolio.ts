export const portfolio = {
  ...
  createHint: "Configure strategy weights after creation",
  portfolioName: "Portfolio name",
  initialCapital: "Initial capital",
  createButton: "Create portfolio",
  created: "Portfolio created",
  createError: "Portfolio creation failed",
  addAllocationTitle: "Add strategy allocation",
  configureStrategy: "Allocation strategy",
  chooseStrategy: "Choose a strategy",
  configureWeight: "Allocation weight",
  weightPlaceholder: "e.g. 0.6",
  effectiveFrom: "Effective from",
  weightTotal: "Current weight total",
  weightHint: "The server validates weights again during attribution",
  addAllocation: "Add allocation",
  allocationError: "Allocation failed",
  submitAttributionTitle: "Submit single-period returns",
  attributionDate: "Attribution date",
  strategyReturn: "Strategy return",
  submitAttribution: "Submit attribution",
  attributionCreated: "Attribution snapshot created",
  attributionError: "Attribution submission failed",
} as const;
